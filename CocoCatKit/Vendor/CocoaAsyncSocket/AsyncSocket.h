 ...
 * and the socket:willDisconnectWithError: delegate method will be called with the specific SSL error code.
 **/
...
// loop by implementing socket:wantsRunLoopForNewSocket:, then you should wait until the
// socket:didConnectToHost:port: method before calling read, write, or startTLS methods.
...
// 
// When a read is complete the socket:didReadData:withTag: delegate method is called.
// When a write is complete the socket:didWriteDataWithTag: delegate method is called.
// 
